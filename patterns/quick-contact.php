<?php
  ...
  * Slug: ikreate-fse/quick-contact
  * Categories: ikreate-fse
  * Keywords: contact, quick contact, contact section
  */
?>
<!-- wp:group {"metadata":{"name":"Quick Contact Area","categories":["ikreate-fse"],"patternName":"ikreate-fse/quick-contact"},"layout":{"type":"constrained"}} -->
...
<h2 class="wp-block-heading has-text-align-center has-white-color has-text-color"><?php esc_html_e('Start your journey','ikreate-fse'); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","textColor":"white","fontSize":"medium"} -->
<p class="has-text-align-center has-white-color has-text-color has-medium-font-size"><?php esc_html_e('Molestie ac feugiat sed lectus vestibulum mattis ullamcorper Amet nulla facilisi morbi tempus iaculis urna id volutpat. Tempor commodo ullamcorper a lacus','ikreate-fse'); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<h5 class="wp-block-heading has-black-color has-text-color"><?php esc_html_e('Start exploring the world today!','ikreate-fse'); ?></h5>
<!-- /wp:heading -->

<!-- wp:buttons -->
<div class="wp-block-buttons"><!-- wp:button {"className":"is-style-fill"} -->
<div class="wp-block-button is-style-fill"><a class="wp-block-button__link wp-element-button" href="#"><?php esc_html_e('Contact us','ikreate-fse'); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div></div>
...
<h3 class="wp-block-heading has-text-align-left has-white-color has-text-color"><?php esc_html_e('Read our travel blog','ikreate-fse'); ?></h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"textColor":"white"} -->
<p class="has-white-color has-text-color"><?php esc_html_e('A wonderful serenity has taken possession of my entire, like these sweet mornings of spring which I enjoy with my heart.','ikreate-fse'); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button is-style-no-border"><a class="wp-block-button__link has-white-color has-text-color has-link-color wp-element-button" href="#"><?php esc_html_e('Read More','ikreate-fse'); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
...
<h3 class="wp-block-heading has-text-align-left"><?php esc_html_e('Quick Contact support','ikreate-fse'); ?></h3>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><?php esc_html_e('Have a question? the professional support team is ready to answer your questions. which I enjoy with my whole heart.','ikreate-fse'); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"style":{"elements":{"link":{":hover":{"color":{"text":"var:preset|color|primary"}},"color":{"text":"var:preset|color|secondary"}}}}} -->
<p class="has-link-color"><a href="mailto:info@example.com"><strong><?php esc_html_e('info@example.com','ikreate-fse'); ?></strong></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
