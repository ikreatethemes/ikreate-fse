<?php
 /**
  * Title: Works Process
  * Slug: ikreate-fse/works-process
  * Categories: ikreate-fse
  * Keywords: works process, working process, process area, works process section, process
  */
?>
<!-- wp:group {"tagName":"section","metadata":{"name":"Works Process","categories":["ikreate-fse"],"patternName":"ikreate-fse/works-process"},"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|lg","bottom":"var:preset|spacing|lg"}}},"layout":{"type":"constrained"}} -->
...
<h2 class="wp-block-heading alignfull has-text-align-center" style="margin-top:var(--wp--preset--spacing--xs);margin-bottom:var(--wp--preset--spacing--xs)"><?php esc_html_e('We Are A Professional Best WordPress Theme Agenc','ikreate-fse'); ?>y</h2>
<!-- /wp:heading -->
...
<h3 class="wp-block-heading has-text-align-right"><a href="#"><?php esc_html_e('Easy Online Booking','ikreate-fse'); ?></a></h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"right"} -->
<p class="has-text-align-right"><?php esc_html_e('WordPress theme is a clean, beautiful, and fully customizable responsive modern free WordPress business theme, especially for App-related landing pages.','ikreate-fse'); ?></p>
<!-- /wp:paragraph -->
...
<h4 class="wp-block-heading has-text-align-left" style="font-size:24px;font-style:normal;font-weight:600"><a href="#"><?php esc_html_e('Work Processing','ikreate-fse'); ?></a></h4>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"left"} -->
<p class="has-text-align-left"><?php esc_html_e('Leverage framework agile to provide a robust synopsis for overviews. Corporate strategy fosters thinking to further the overall value proposition.','ikreate-fse'); ?></p>
<!-- /wp:paragraph -->
...
<h4 class="wp-block-heading has-text-align-right" style="font-size:24px;font-style:normal;font-weight:600"><a href="#"><?php esc_html_e('Success Project','ikreate-fse'); ?></a></h4>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"right"} -->
<p class="has-text-align-right"><?php esc_html_e('Have a question? Our professional support is ready to answer your questions. All our team member support requests will be replied in 24 hours or less.','ikreate-fse'); ?></p>
<!-- /wp:paragraph -->
