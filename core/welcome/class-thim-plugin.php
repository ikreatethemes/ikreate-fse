...
/**
 * Class ikreate_fse_welcome_Plugin.
 *
 * @since   0.4.0
 *
 * @version 1.1.0
 */
if ( ! class_exists( 'ikreate_fse_welcome_Plugin' ) ) {
	...
	class ikreate_fse_welcome_Plugin {
		...
		public function update() {
			do_action( 'ikreate_fse_welcome_core_pre_upgrade_plugin', $this );
